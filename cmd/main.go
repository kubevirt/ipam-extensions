...
func main() {
	...
	var certDir string
	var overrideDefaultNetworkNadNamespace string
	...
	flag.StringVar(
		&overrideDefaultNetworkNadNamespace,
		"override-default-network-nad-namespace",
		"ovn-kubernetes",
	...
	mgr.GetWebhookServer().Register(
		"/mutate-v1-pod",
		&webhook.Admission{Handler: ipamclaimswebhook.NewIPAMClaimsValet(
			mgr,
			ipamclaimswebhook.WithDefaultNetNADNamespace(overrideDefaultNetworkNadNamespace),
		)},
	)
